...
public class GoogleDriveConfig {
    ...
    private static final String CREDENTIALS_FILE_PATH = "/client_secret_646335308823-sgifjhnfjrocs3lgv02ds7ji6ojjdqsf.apps.googleusercontent.com.json"; // Relative path
    ...
    public static Credential getCredentials(final com.google.api.client.http.HttpTransport HTTP_TRANSPORT) throws IOException {
        ...
        if (in == null) {
            throw new FileNotFoundException("Credentials file not found at: " + CREDENTIALS_FILE_PATH +
                    ". Ensure the file is placed in the 'resources' directory.");
        }
        GoogleClientSecrets clientSecrets = GoogleClientSecrets.load(JSON_FACTORY, new InputStreamReader(in));

        // Flow with tokens stored locally
        ...
        // Use AuthorizationCodeInstalledApp with LocalServerReceiver
